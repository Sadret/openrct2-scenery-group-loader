# OpenRCT2 Plug-In Template

<!--- TODO: one-line description of the plugin -->
An OpenRCT2 plug-in.
...
2. Go to the [releases](https://github.com/Sadret/openrct2-scenery-group-loader}/releases) page and download the `openrct2-scenery-group-loader-?.?.?.js` file from the latest release, where `?.?.?` is the version number. Save it in the `plugin` subfolder of your OpenRCT2 user directory.\
...
The OpenRCT2 plug-in "Scenery Group Loader" is licensed under the GNU General Public License version 3.
